...
// Section wrapper for the Day-by-Day Journey. Hosts the section header,
// drag-and-drop, and a single add-day affordance. The day card system
// itself lives entirely in `day-card/` — five signature layouts driven
    ...
    <div className="py-24 md:py-28" style={{ background: tokens.pageBg }}>
      <div className="ed-wide">
        ...
        <div className="flex items-end justify-between mb-16 gap-6 flex-wrap">
          ...
          <div className="text-small pb-1" style={{ color: tokens.mutedText }}>
            ...
            {section.layoutVariant === "auto" ? (
              <span className="ml-2 opacity-60">· layouts vary by moment</span>
            ) : null}
          </div>
        </div>
        ...
        <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
          ...
          >
            {/* Generous vertical rhythm — 96px between days on desktop. */}

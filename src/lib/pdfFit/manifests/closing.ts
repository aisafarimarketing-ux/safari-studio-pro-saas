...
// ─── Aliases — magazine variant names map to existing PdfFit layouts ────
// editorial-close → farewell (very similar editorial close)
// stack          → cinematic (full-bleed hero + caption + centred letter)
export const CLOSING_EDITORIAL_CLOSE: LayoutManifest = {
  ...CLOSING_FAREWELL,
  id: "editorial-close",
  description: "Magazine editorial close — single trip-theme photo + letter + CTAs",
};

...
export const SECTION_REGISTRY: Record<SectionType, SectionDefinition> = {
  ...
  cover: {
    ...
    variants: ["editorial-magazine", "cinematic-split", "flip-split", "centered-editorial", "minimal-type", "full-bleed-overlay"],
    defaultVariant: "editorial-magazine",
  ...
  dayJourney: {
    ...
    variants: ["magazine-feature", "split-text-image", "flip-split", "stacked-image-text", "compact-timeline", "magazine-spread", "full-image-overlay"],
    defaultVariant: "magazine-feature",
    defaultContent: {},
    dataSource: "days",
  },
  propertyShowcase: {
